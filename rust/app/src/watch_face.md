...
1. `*const ::cty::c_char` (pointer to a C string, which may or may not be null-terminated) has been replaced by the safer `&Strn` (reference to a null-terminated string object)
